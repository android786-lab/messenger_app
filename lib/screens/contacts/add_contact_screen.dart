...
class _AddContactScreenState extends State<AddContactScreen> {
  ...
  Future<void> _save() async {
    ...
    final success = await ctrl.addContact(
    ...
    final msg = success
        ? ctrl.successMessage ?? 'Contact saved.'
        : ctrl.errorMessage ?? 'Could not save contact.';
      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(primary: AppTheme.lightPrimaryColor),
          ),
          child: child!,
        );
      },
            ...
            children: [
              ...
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      _showMoreFields ? 'Show Less' : 'Add More Details',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'If this person has the app and registered with this number, they will appear when you start a new chat.',
                        style: TextStyle(
                          color: AppTheme.lightTextSecondary,
                          fontSize: 13,
                        ),
